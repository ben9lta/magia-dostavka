            ...
            <div class="box_general padding_bottom">
                <div class="header_box version_2">
                    ...
                    <div class="pull-right">
                        <a href="{{route('option-categories.create')}}" class="btn badge-primary">Добавить</a>
                    </div>
                </div>
                    ...
                    <table class="table">
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('option-categories.show', $category->id)}}"><i
                                            class="fa fa-fw fa-eye"></i></a>
                                    <a href="{{route('option-categories.edit', $category->id)}}"><i
                                            class="fa fa-fw fa-edit"></i></a>
                                    <form style="display: inline" action="{{ route('option-categories.destroy' , $category->id)}}" method="POST"
