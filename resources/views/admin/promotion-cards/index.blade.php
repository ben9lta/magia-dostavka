<?php
/**
 * @var \App\Models\PromotionCards\PromotionCards[] $promotions
 */
...
{{--                        <a href="{{route(Controller::ROUTE_REFRESH)}}" class="btn badge-primary">Обновить файл</a>--}}
                    ...
                    <table class="table">
                        ...
                        @foreach($promotions as $model)
                            <tr>
                                ...
                                <td>
                                    {{$model->status ? 'Активный' : 'Неактивный'}}
                                </td>
                                <td>
